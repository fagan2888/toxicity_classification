...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun  9 09:23:16 2019
...
## Word of Bags    
count_vectorizer = TfidfVectorizer(analyzer='word', tokenizer=TweetTokenizer().tokenize, stop_words=stopwords.words('english'), max_features=10000)    
bag_of_words = count_vectorizer.fit_transform(X)

clf = LogisticRegression(solver='lbfgs', max_iter=200, verbose=1)
